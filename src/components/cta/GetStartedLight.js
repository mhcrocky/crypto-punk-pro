...
const PrimaryBackgroundContainer = tw.div`py-16 lg:py-10 bg-purple-200 rounded-lg relative`
...
export default ({
  subheading = "Interested in Selling ?",
  heading = "",
  primaryLinkText = "Sell",
  primaryLinkUrl = "http://google.com",
  secondaryLinkText = "Rules",
